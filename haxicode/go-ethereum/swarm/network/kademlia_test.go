...
import (
	...
	"github.com/haxicode/go-ethereum/swarm/pot"
)
...
func TestKademliaHiveString(t *testing.T) {
	...
	k.MaxProxDisplay = 8
	h := k.String()
	expH := "\n=========================================================================\nMon Feb 27 12:10:28 UTC 2017 KΛDΞMLIΛ hive: queen's address: 000000\npopulation: 2 (4), MinProxBinSize: 2, MinBinSize: 1, MaxBinSize: 4\n000  0                              |  2 8100 (0) 8000 (0)\n============ DEPTH: 1 ==========================================\n001  1 4000                         |  1 4000 (0)\n002  1 2000                         |  1 2000 (0)\n003  0                              |  0\n004  0                              |  0\n005  0                              |  0\n006  0                              |  0\n007  0                              |  0\n========================================================================="
	if expH[104:] != h[104:] {
...
=========================================================================
Mon Apr  9 12:18:24 UTC 2018 KΛDΞMLIΛ hive: queen's address: 7efef1
...
=========================================================================
Mon Apr  9 18:43:48 UTC 2018 KΛDΞMLIΛ hive: queen's address: bc7f3b
population: 9 (49), MinProxBinSize: 2, MinBinSize: 2, MaxBinSize: 4
...
=========================================================================
Mon Apr  9 19:04:35 UTC 2018 KΛDΞMLIΛ hive: queen's address: b4822e
...
=========================================================================
Mon Apr  9 19:16:25 UTC 2018 KΛDΞMLIΛ hive: queen's address: 9a90fe
population: 8 (49), MinProxBinSize: 2, MinBinSize: 2, MaxBinSize: 4
...
=========================================================================
Mon Apr  9 19:25:18 UTC 2018 KΛDΞMLIΛ hive: queen's address: 5dd5c7
